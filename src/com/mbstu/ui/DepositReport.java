...
public class DepositReport extends JInternalFrame {
 ...
 Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public DepositReport(String AccNum,String s1,String s2,String s3) {

        super("Report",true,true,true,true);
           System.out.println("Account Num"+s1+" Date"+s2+"Ammount"+s3);
        ...
        jPanel2.setBackground(new java.awt.Color(204, 204, 204));
         jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 255)));
            ...
            label1=new JLabel("Deposit Report 2013");
            jPanel2.add(label1);
       ...
       setLocation(210,150);
        ...
        try {
            Statement statement =DatabaseConnection.getConnection().createStatement();
            {
                ...
                String temp = ("SELECT Name,Account_Num,Date,Ammount from DepositInfo WHERE Account_Num='"+AccNum+"'");
                int Numrow = 0;
